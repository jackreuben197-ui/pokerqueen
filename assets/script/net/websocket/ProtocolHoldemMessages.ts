...
import { ClientMessageAgreePost } from "../../protobuf/holdem/req_agree_post_pb";
...
// export class Protocol_Holdem_KeepSeatActive extends BaseProtocol {
//     static Name: string = "Protocol_Holdem_KeepSeatActive";
//     static _request: ClientMessageKeepSeatActive = null;
//     public static Request_AsObject: ClientMessageKeepSeatActive.AsObject = null;
//     public static Response_AsObject: ServerMessageKeepSeatActive.AsObject = null;

//     static Request(body?: ClientMessageKeepSeatActive.AsObject): Uint8Array {
//         this._request || (this._request = new ClientMessageKeepSeatActive());
//         this.SetBody(this._request, body, { room: Room });
//         return this._request.serializeBinary();
//     }
//     static Response(bytes: Uint8Array): ServerMessageKeepSeatActive.AsObject {
//         let result: ServerMessageKeepSeatActive = ServerMessageKeepSeatActive.deserializeBinary(bytes);
//         return result.toObject();
//     }
// }

// export class Protocol_Holdem_AddTime extends BaseProtocol {
//     static Name: string = "Protocol_Holdem_KeepSeatActive";
//     static _request: ClientMessageAddTime = null;
//     public static Request_AsObject: ClientMessageAddTime.AsObject = null;
//     public static Response_AsObject: ServerMessageAddTime.AsObject = null;

//     static Request(body?: ClientMessageAddTime.AsObject): Uint8Array {
//         this._request || (this._request = new ClientMessageAddTime());
//         this.SetBody(this._request, body, { room: Room });
//         return this._request.serializeBinary();
//     }
//     static Response(bytes: Uint8Array): ServerMessageAddTime.AsObject {
//         let result: ServerMessageAddTime = ServerMessageAddTime.deserializeBinary(bytes);
//         return result.toObject();
//     }
// }
...
// cc.js.setClassName("Protocol_Holdem_KeepSeatActive", Protocol_Holdem_KeepSeatActive);
// cc.js.setClassName("Protocol_Holdem_AddTime", Protocol_Holdem_AddTime);
