...
export default class SeatUIRC extends UIBase {
    ...
    protected override lateLoad(): void {
        ...
        this.Label_SquidCount = this.PlayerSquidLabel?.getChildByName('PlayerSquidLabelCount')?.getComponent(cc.Label);
    ...
    protected onClickCard(button: cc.Button): void {
        ...
        if (
            ...
            this.seat.Player.userID != GameCache.Instance.CurGame.mainPlayer.userID ||
