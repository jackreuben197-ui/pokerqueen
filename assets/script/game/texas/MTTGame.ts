...
import { ClientMessageAddOn } from '../../protobuf/holdem/req_th_add_on_pb';
                            ...
                            WWW.Instance.CommonAPI({
                                ...
                                (res: any) => {
                                    if (GameCache.Instance.gold_type == 1) {
                                        //1 联盟币， 2 usdt, 3 记分牌
                                        menu.$node_coin.getChildByName('label').getComponent(cc.Label).string = StringHelper.GetLongString(
