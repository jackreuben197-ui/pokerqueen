...
export class some_pos {
    ...
    public static readonly all_mushroom_pos: cc.Vec3[] = [
        cc.v3(105, 60), //中下为自己的位置
        cc.v3(105, 60), //除自己外所有方位的位置
        cc.v3(105, 60),
        cc.v3(105, 60),
        cc.v3(105, 60),
        cc.v3(105, 60),
        ...
        cc.v3(-125, 60),
        cc.v3(-125, 60),
        cc.v3(105, 60), // 10 中下为自己的位置
        cc.v3(105, 60) // 11 中下为其他玩家的位置
    ];
...
export default class GameUtil {
    ...
    public static pos_config: { [key: number]: seat_info[] } = {
        ...
        3: [new seat_info(0), new seat_info(3), new seat_info(7)],
        4: [new seat_info(0), new seat_info(2), new seat_info(5), new seat_info(8)],
        5: [new seat_info(0), new seat_info(2), new seat_info(4), new seat_info(6), new seat_info(8)],
        6: [new seat_info(0), new seat_info(1), new seat_info(3), new seat_info(5), new seat_info(7), new seat_info(9)],
        7: [new seat_info(0), new seat_info(1), new seat_info(3), new seat_info(4), new seat_info(6), new seat_info(7), new seat_info(9)],
        8: [new seat_info(0), new seat_info(1), new seat_info(2), new seat_info(3), new seat_info(5), new seat_info(7), new seat_info(8), new seat_info(9)],
        9: [
            new seat_info(0),
            new seat_info(1),
            new seat_info(2),
    ...
    public static Seat_ElementPos: {
        ...
        2: {
            myCardsPos: [cc.v3(-65, 216), cc.v3(65, 216)],
            backSmallCardPos: [cc.v3(-15, 5), cc.v3(15, 5)],
            smallCardPos: [cc.v3(-48, 0), cc.v3(45, 0)],
            myCardTypePos: [cc.v3(-210, 55)],
            voiceStatePositon: cc.v3(284, -237, 0),
            myCardsScale: 1
        },
        4: {
            myCardsPos: [cc.v3(-120, 216), cc.v3(-40, 216), cc.v3(40, 216), cc.v3(120, 216)],
            backSmallCardPos: [cc.v3(-30, 5), cc.v3(-10, 5), cc.v3(10, 5), cc.v3(30, 5)],
            smallCardPos: [cc.v3(-42, 0), cc.v3(-15, 0), cc.v3(11, 0), cc.v3(38, 0)],
            myCardTypePos: [cc.v3(-210, 55)],
            voiceStatePositon: cc.v3(335.4, -232, 0),
            myCardsScale: 1
        },
        5: {
            myCardsPos: [cc.v3(-120, 216), cc.v3(-60, 216), cc.v3(0, 216), cc.v3(60, 216), cc.v3(120, 216)],
            backSmallCardPos: [cc.v3(-40, 5), cc.v3(-20, 5), cc.v3(0, 5), cc.v3(20, 5), cc.v3(40, 5)],
            smallCardPos: [cc.v3(-55, 0), cc.v3(-28, 0), cc.v3(-3, 0), cc.v3(24, 0), cc.v3(52, 0)],
            myCardTypePos: [cc.v3(-210, 55)],
            voiceStatePositon: cc.v3(446, -233, 0),
            myCardsScale: 1
        },
        6: {
            myCardsPos: [cc.v3(-150, 216), cc.v3(-90, 216), cc.v3(-30, 216), cc.v3(30, 216), cc.v3(90, 216), cc.v3(150, 216)],
            backSmallCardPos: [cc.v3(-50, 5), cc.v3(-30, 5), cc.v3(-10, 5), cc.v3(10, 5), cc.v3(30, 5), cc.v3(50, 5)],
            smallCardPos: [cc.v3(-68, 0), cc.v3(-42, 0), cc.v3(-15, 0), cc.v3(11, 0), cc.v3(37, 0), cc.v3(64, 0)],
            myCardTypePos: [cc.v3(-210, 55)],
