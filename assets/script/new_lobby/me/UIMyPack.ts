...
export default class UIMyPack extends BaseFormPlus {
        ...
        switch (item_data.prop_type) {
            ...
            case 2://实物
                dialog_param = {
                    ...
                    content: i18nMgr.Get("UIBackDiolg_textContent03").replace("{0}", item_data.game_prop?.prop_name || item_data.prop_name),
                    info: item_data,
                    this: this
                }
    ...
    reqUsed(item_data: any) {
        WebWww.Instance.CommonAPI(
            ...
            (res: any) => {
                UIComponent.Instance.ToastLanguage("UIMine_Backpack_UsedSuccess");
