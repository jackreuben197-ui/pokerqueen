 ...
 * @LastEditTime: 2023-04-24 12:53:04
 * @FilePath: /pokerqueen/assets/script/new_lobby/me/UIChangeBind.ts
 */
    ...
    initUI(param) {
        ...
        if (param == 1) {
            ...
            if (data.phone_status.status) {
                this.comFormTitle.initData(i18nMgr.Get('UISetting_SecurityBindChange') + i18nMgr.Get('UISetting_SecurityBindTelNum'), this);
                this.title_tip.string = i18nMgr.Get('UISetting_SecurityBindAlert')
            } else {
                this.comFormTitle.initData('UISetting_SecurityBindTel', this);
                this.title_tip.string = i18nMgr.Get('UIBindPhoneTips')
            }
        } else {
            this.areaNode.active = false;
            this.mailNode.active = true;
            if (data.email_status.status) {
                this.title_tip.string = i18nMgr.Get('UISetting_SecurityBindEmailAlert')
                this.comFormTitle.initData('UIMine_ChangeEmail', this);
                this.comFormTitle.initData(i18nMgr.Get('UISetting_SecurityBindChange') + i18nMgr.Get('UISetting_SecurityBindEmailNum'), this);

            } else {
                this.title_tip.string = i18nMgr.Get('UIMine_BindEmailTips')
                this.comFormTitle.initData('UISetting_SecurityBindEmail', this);
            }
        }
    }
    /**
