    ...
    APIUserDiamondsWallet() {
        return new Promise((resolve, reject) => {
            HttpRequest.Send({
                ...
                body: APIOrgClubShareApplyList.Request({}),
                onSuccess: function () {
