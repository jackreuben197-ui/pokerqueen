...
export default class UIFriendMatchItem extends UIBase {
    ...
    initData(data) {
        ...
        this.setText(this.lbl_status, this._data.status == 1 ? 'adaptation10177' : 'adaptation10186');

        let lbl_num = this.labelNode.getChildByName('lbl_num').getComponent(cc.Label)
