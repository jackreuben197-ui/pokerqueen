        ...
        switch (this._param.walletType) {
            ...
            case WalletType.Club://公会玩家钱包
                ...
                if (this._param.type == 1) {
                    UIClubModel.mInstance.CommonAPI(ClubCache.club_id, { amount: value, gold_type: gold_type }, Web_Recharge_Gold).then(
                        (res) => {
                ...
                if (this._param.type == 2) {
                    UIClubModel.mInstance.CommonAPI(ClubCache.club_id, { amount: value, gold_type: gold_type }, Web_Tiqu_Gold).then(
                        (res) => {
