...
export class UIMTTModel {
    ...
    public HandleMTTJoinAction(actionType: MTTJoinAction, resultCallback: any, exceptionCallback: any = null, args: any = null, checkGPS: boolean = true) {
    ...
    MTTJoinActionHandler(actionType: MTTJoinAction, resultCallback: any, exceptionCallback: any, args: any) {
        switch (actionType) {
    ...
    MTTRebuyActionHandler(resultCallback, exceptionCallback) {
        ...
        this.RequestMTTDetails(
            this.MttInfo.mtt.match_id,
            code => {
                if (code == 0) {
                    let cost: any;
