...
export default class GoogleApi {
    ...
    static loginSuc(msg: any) {
        ...
        if (this.func && this.func instanceof Function) {
            ...
            LoginSession.WebLoginThirdParty({ id_token: this.credential, source: 'google', app_source: 3 }).then(() =>
    ...
    static renderBtn() {
        ...
        (window as any).google && (window as any).google.accounts.id.renderButton(document.getElementById('button_div'), { type: 'icon' });
    }
