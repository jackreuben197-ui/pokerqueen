...
export default class FaceBookApi {
    ...
    static loginSuc(msg: TFackBookLoginRspAuth) {
        ...
        // let str = Buffer.from(this.rspData.accessToken, 'base32').toString();
        // console.log("================> facebook accessToken 解析  : ", str)
        // str = Buffer.from(this.rspData.signedRequest, 'base32').toString();
        // console.log("================> facebook signedRequest 解析  : ", str)
