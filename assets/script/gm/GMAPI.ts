...
export class GM {
    ...
    private steps = [
        ...
        {
            key: 'Protocol_Holdem_PublicCards',
            value: {
                publicCardsArrayList: [14, 22, 52],
                nextOperator: {
                    seatId: 1,
                    actionsList: [],
                    insuranceLimitList: [],
        ...
        {
            key: 'Protocol_Holdem_InsuranceTrigged',
            value: {
                round: 2,
                operatorList: [
                    {
        ...
        {
            key: 'Protocol_Holdem_BuyInsurance',
            value: { round: 2, seatId: 2, buyList: [] }
        }
    ];
